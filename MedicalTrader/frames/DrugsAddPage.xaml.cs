...
namespace MedicalTrader
{
    ...
    /// </summary>
    public partial class DrugsAddPage : Page
    {
        private DataGrid mainDataGrid;
     

        // Добавление препарата вручную
        public DrugsAddPage(DataGrid dataGrid = null)
        {
        ...
        Drug GetDrugByFields(Drug drug)
        {
            ...
            drug.seriesManufacturer = this.seriesManufacturer.Text;
        ...
        public DrugsAddPage(string certNumber, DataGrid dataGrid = null)
        {
            InitializeComponent();
            initComboBox();
            mainDataGrid = dataGrid;
